...
This plot looks really clean and gives us a good idea of which platforms are the most popular with single-platform users. However, using the actual number of participants gives us a lot of squares to look at. It may be more visually appealing and interpretable to make a visualization of proportions with a 10 x 10 plot. 
